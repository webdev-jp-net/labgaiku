  ...
  return (
    <main className={styles.home} data-testid="home">
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          これまで、気になるゲストへインタビューをしてじっくり話を聞いたり、人と働く仕組みづくりを研究したり、AIエージェントへの愛着と愚痴をとことん語らったり、いにしへのインターネットについて思い出話をしたり、位相幾何学がいかに分からないか受け止めたり、ベトナムの暮らしが思ったよりファンキーだった真実に驚いたり、いろいろな雑談をしてきました。
        </p>
        <p className={styles.paragraph}>
          成果に近い応用研究ではなく、知識そのものに近い基礎研究へ夢中になる体験、これは、緊急度が低いけれど重要度は高いことなのかもしれません。
          Labの時間は、すぐさま役に立つことのないbuffer（アソビ）でplayfulness（遊び）なのですが、そうしたていねいな余白やノイズは&ldquo;無意味の意味&rdquo;にふと気づく時間にも思えます。
        </p>
