...
- 要件定義書の新規作成・更新・修正
- 各要件定義書からの要件抽出
- `_llm-docs`配下の要件定義所から内容を抽出
- `docs/project.md`へのプロジェクト全体の要件定義書mdファイル設置

**読み込むルール:**
- `_llm-rules/core_rules.md`（必須・確認済み）

**作業内容:**
- `_llm-docs`配下の要件定義書を分析
- プロジェクト全体の要件定義書として必要な内容を抽出
- `docs/project.md`にプロジェクト全体の要件定義書用のmdファイルを作成・更新

**重要な制約事項:**
- 要件定義書に明記されていない機能や要件は追加しない
- 憶測や推測による内容の補完は禁止
- 未記入のセクションは「※要件定義書に記載なし」と明記
- 具体的な数値や仕様は要件定義書に記載がある場合のみ記載
- 業界の一般的な要件であっても、要件定義書に記載がなければ記載しない
